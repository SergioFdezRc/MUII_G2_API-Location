...
class TestLocationController(BaseTestCase):
    ...
    @mock.patch("swagger_server.db.Database.PostgresDB.insert_new_location")
    ...
    @mock.patch("swagger_server.db.Database.PostgresDB.get_locations")
    ...
    @mock.patch("swagger_server.db.Database.PostgresDB.get_last_location")
